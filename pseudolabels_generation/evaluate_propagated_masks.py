...
import sys
from TorchIR.utils.eval import compute_geometric_metrics, compute_area_label
import os
import pandas as pd
...
def prepare_ground_truths(TED_path, ted2camus_path, size=(512,512), overwrite=False):
    ...
    if os.path.exists(output_path) and not overwrite:
        raise Exception("Folder already exists. Set `overwrite` to True to overwrite it.")
...
if __name__ == "__main__":
    ...
    prepare_ground_truths(TED_path="../data/ted/database",
                          ted2camus_path="../data/ted2camus.csv",
                          size=(512,512),
                          overwrite=False)