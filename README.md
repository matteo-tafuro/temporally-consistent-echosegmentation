...
This repository hosts the code associated with the paper _"Temporally consistent segmentations from sparsely labeled echocardiograms using image registration for pseudo-label generation"_ presented in the [International Workshop on Advances in Simplifying Medical Ultrasound (ASMUS)](https://miccai-ultrasound.github.io/#/asmus23), held in conjunction with [MICCAI 2023](https://conferences.miccai.org/2023/).
