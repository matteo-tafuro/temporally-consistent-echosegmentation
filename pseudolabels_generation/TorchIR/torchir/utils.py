...
class Resampler(nn.Module):
    ...
    def forward(self, input, coord_grid, choose_mode = None):
        ...
        return F.grid_sample(
            input,
            coord_grid,
            mode=self.mode if choose_mode is None else choose_mode,
...
class IRDataSet(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return {"fixed": self.ds[fixed_idx][0], "moving": self.ds[moving_idx][0]}
